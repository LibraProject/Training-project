...
const routes = [
    { component: Login, path: '/login' },
    {
        ...
        path: '/home',
        children: [
            { path: '/home', redirect: '/home/look' },
            { component: Add, path: '/home/add' },
            { component: AddTest, path: '/home/addTest' },
            { component: AddQuestion, path: '/home/addQuestion/:id' },
            { component: ClassRoom, path: '/home/classRoom' },
            { component: Classify, path: '/home/classify' },
            { component: Correct, path: '/home/correct' },
            { component: Detail, path: '/home/detail/:id' },
            { component: Edit, path: '/home/edit' },
            { component: Exhibition, path: '/home/exh' },
            { component: Grade, path: '/home/grade' },
            { component: List, path: '/home/list' },
            { component: Look, path: '/home/look' },
            { component: Rank, path: '/home/rank' },
            { component: Student, path: '/home/student' },
